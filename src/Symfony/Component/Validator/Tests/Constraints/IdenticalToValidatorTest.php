...
class IdenticalToValidatorTest extends AbstractComparisonValidatorTestCase
{
    ...
    public function provideInvalidComparisons()
    {
        return array(
            ...
            array(new \DateTime('2001-01-01'), '2001-01-01 00:00:00', new \DateTime('2001-01-01'), '2001-01-01 00:00:00', 'DateTime'),
            array(new \DateTime('2001-01-01'), '2001-01-01 00:00:00', new \DateTime('1999-01-01'), '1999-01-01 00:00:00', 'DateTime'),

...
class LessThanValidatorTest extends AbstractComparisonValidatorTestCase
{
    ...
    public function provideInvalidComparisons()
    {
        return array(
            ...
            array(new \DateTime('2010-01-01'), '2010-01-01 00:00:00', new \DateTime('2000-01-01'), '2000-01-01 00:00:00', 'DateTime'),
            array(new \DateTime('2000-01-01'), '2000-01-01 00:00:00', new \DateTime('2000-01-01'), '2000-01-01 00:00:00', 'DateTime'),
